...
if TYPE_CHECKING:
    ...
    from entity import ConsumableItem, EquippableItem
...
class InventoryEventHandler(AskUserEventHandler):
    ...
    def on_item_selected(self, item: ConsumableItem) -> Optional[ActionOrHandler]:
...
class InventoryActivateHandler(InventoryEventHandler):
    ...
    def on_item_selected(self, item: ConsumableItem) -> ActionOrHandler | None:
